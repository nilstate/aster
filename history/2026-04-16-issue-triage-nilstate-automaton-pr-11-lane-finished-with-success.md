...
subject_locator: nilstate/automaton#pr/11
...
A `issue-triage` run against `nilstate/automaton#pr/11` finished with `success`.

Summary: lane finished with success

Receipt reference: `rx_4942c45a38f844ec86aaec29f37dad7c`.
