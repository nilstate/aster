...
`runx` is the substrate. Work here should sharpen generic primitives, receipt
quality, and hosted boundaries without smuggling `maton` semantics into the
runtime.
...
- `issue-triage`: route substrate-repo friction toward bounded fixes or docs without drifting into maton-only language.
