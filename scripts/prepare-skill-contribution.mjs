...
function buildPrBody(context, options) {
  return `${[
    ...
    "## Why this helps",
    "",
    "Agents already inspect README files, package scripts, CI config, Docker docs, and release scripts when working in a repo. A dedicated `SKILL.md` gives them a stable workflow contract so they can make safer, more repo-specific decisions without changing the runtime or requiring any platform.",
    "",
